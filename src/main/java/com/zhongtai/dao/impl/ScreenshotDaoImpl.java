...
@Service("screenshotDao")
public class ScreenshotDaoImpl extends MongodbFactory implements IScreenshotDao {

	DBCollectionInfo collectioninfo = null;

	public ScreenshotDaoImpl() {

		collectioninfo = new DBCollectionInfo();
		collectioninfo.setCollectionName(Screenshot.class.getSimpleName());
