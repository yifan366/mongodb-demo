...
@Service("previewImageDao")
public class PreviewImageDaoImpl extends MongodbFactory implements IPreviewImageDao {
	DBCollectionInfo collectioninfo = null;

	public PreviewImageDaoImpl() {

		collectioninfo = new DBCollectionInfo();
		collectioninfo.setCollectionName(PreviewImage.class.getSimpleName());
